  ...
  return (
    <Box m="20px">
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center">
        <Header title="PAYMENT METHOD" subtitle="View a Payment Method" />
        ...
        <Box>
          <Button
            ...
            onClick={() => navigate("/dashboard/paymentmethod")}
          >
      ...
      >
        ...
        <Box>
            ...
            {viewdata?.label}</Typography>
            </Box>
        <Box sx={{
                    textAlign:"center"
                  }}>
            <img src={viewdata?.image}     style={{ width: "100%", maxHeight: "100%" }} />
        </Box>
