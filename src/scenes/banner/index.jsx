...
const Banner = () => {
  ...
  const handleView = (id) => {
    navigate(`/dashboard/banner/view/${id}`);
  };

  const handleEdit = (id) => {
    navigate(`/dashboard/banner/addBanner/${id}`);
  };
  ...
  return (
    <Box p={2}>
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center">
        <Header title="Banner" subtitle="Manage Banner" />
        ...
        <Box>
          <Button
            ...
            onClick={() => navigate("/dashboard/banner/addbanner")}
          >
            <AddIcon sx={{ mr: "10px" }} />
            Add Banner
          </Button>
