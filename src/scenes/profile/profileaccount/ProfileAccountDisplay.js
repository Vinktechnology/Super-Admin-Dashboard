...
function ProfileAccountDisplay({ item }) {
    ...
    <>
      ...
      >
        ...
        <Box sx={{paddingLeft:"1rem"}}>
          <Box>
            <Typography sx={{   color: colors.grey[700],fontSize:"14px",  fontWeight: "600",}} >Display Name</Typography>
            <Typography sx={{   color: colors.grey[400],fontSize:"14px",  fontWeight: "600",}}>Vikrant Kaushik</Typography>
          </Box>
          <Box sx={{marginTop:".6rem"}}>
            <Typography sx={{   color: colors.grey[700],fontSize:"14px",  fontWeight: "600",}}>Business Description</Typography>
            <Typography sx={{   color: colors.grey[400],fontSize:"14px",  fontWeight: "600",}}>
              7 files changed, 231 insertions(+), 12 deletions(-) create mode
              100644 src/scenes/profile/index.js create mode 100644
            </Typography>
          </Box>
        </Box>
      </Box>
