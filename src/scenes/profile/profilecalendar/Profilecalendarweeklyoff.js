    ...
    function Profilecalendarweeklyoff({ item }) {
        ...
        <>
          ...
          >
            ...
            <Box sx={{paddingLeft:"1rem", marginTop:"1rem"}}>
              <Box>
                <Typography sx={{   color: colors.grey[700],fontSize:"14px",  fontWeight: "600",}} >Weekly Off</Typography>
                <Typography sx={{   color: colors.grey[400],fontSize:"14px",  fontWeight: "600",}}>Sunday</Typography>
              </Box>
            </Box>
          </Box>
    ...
    export default Profilecalendarweeklyoff;
