...
function ProfilePickUpAddress({ item ,ind}) {
      ...
      >
        ...
        >
          <Box sx={{ width: "90%" }}>
            ...
            >
              {item?.heading+" "+(parseInt(item?.ind)+1)}
            </Typography>
...
export default ProfilePickUpAddress;
