  ...
  return (
    <Box>
      ...
      >
        ...
        >
          <Header title="" subtitle="Manage Website Pinterest URL" />
          <Grid container>
            <Grid xs={9} sm={8} md={8} lg={8} xl={8} sx={{ p: 1 }}>
              <Element
                eletype={inputType.input}
                label="Please enter website Pinterest URL"
                placeholder="Please enter website Pinterest URL"
                inputProps={{
                  onChange: handleChange,
                  onBlur: handleBlur,
                  name: "pinterest",
                }}
                errorText={touched.pinterest && errors.pinterest}
...
export default UtilityPInterest;
