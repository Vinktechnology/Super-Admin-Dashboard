...
const UtilityFacebook = () => {
  ...
  useEffect(() => {
    if (utility) {
          setInitialValues({
            faceBook: utility?.socialMediaLinks?.faceBook?.url || "",
          });
    }
  }, [utility]);
  ...
  return (
    <Box>
      ...
      >
        ...
        >
          <Header title="" subtitle="Manage Website Facebook URL" />
          <Grid container>
            <Grid xs={9} sm={8} md={8} lg={8} xl={8} sx={{ p: 1 }}>
              <Element
                eletype={inputType.input}
                label="Please enter website Facebook URL"
                placeholder="Please enter website Facebook URL"
                inputProps={{
...
export default UtilityFacebook;
