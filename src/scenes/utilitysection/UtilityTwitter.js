  ...
  return (
    <Box>
      ...
      >
        ...
        >
          <Header title="" subtitle="Manage Website Twitter URL" />
          <Grid container>
            <Grid xs={9} sm={8} md={8} lg={8} xl={8} sx={{ p: 1 }}>
              <Element
                eletype={inputType.input}
                label="Please enter website Twitter URL"
                placeholder="Please enter website Twitter URL"
                inputProps={{
                  onChange: handleChange,
                  onBlur: handleBlur,
                  name: "twitter",
                }}
                errorText={touched.twitter && errors.twitter}
