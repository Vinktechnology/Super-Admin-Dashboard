  ...
  return (
    <Box>
      ...
      >
        ...
        >
          <Header title="" subtitle="Manage Website Play Store URL" />
          <Grid container>
            <Grid xs={9} sm={8} md={8} lg={8} xl={8} sx={{ p: 1 }}>
              <Element
                eletype={inputType.input}
                label="Please enter website Play Store URL"
                placeholder="Please enter website Play Store URL"
                inputProps={{
                  onChange: handleChange,
                  onBlur: handleBlur,
                  name: "googlePlayButton",
                }}
                errorText={touched.googlePlayButton && errors.googlePlayButton}
                value={values.googlePlayButton}
...
export default UtilityGooglePlayButton;
