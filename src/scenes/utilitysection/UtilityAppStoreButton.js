...
const UtilityAppStoreButton = () => {
  ...
  useEffect(() => {
    if (utility) {
          setInitialValues({
            appStoreButton: utility?.appStoreButton || "",
          });
    }
  }, [utility]);
  ...
  return (
    <Box>
      ...
      >
        ...
        >
          <Header title="" subtitle="Manage Website App Store URL" />
          <Grid container>
            <Grid xs={9} sm={8} md={8} lg={8} xl={8} sx={{ p: 1 }}>
              <Element
                eletype={inputType.input}
                label="Please enter website App Store URL"
                placeholder="Please enter website App Store URL"
                inputProps={{
                  onChange: handleChange,
                  onBlur: handleBlur,
                  name: "appStoreButton",
                }}
                errorText={touched.appStoreButton && errors.appStoreButton}
                value={values.appStoreButton}
...
export default UtilityAppStoreButton;
