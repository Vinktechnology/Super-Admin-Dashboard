...
import { getHeaderAndFooterByIdThunk } from "../../store/slices/headerfooter/headerfooter.slice.js";

const ViewHeaderAndFooter = () => {
  ...
  return (
    <Box m="20px">
      <Box display="flex" justifyContent="space-between" alignItems="center">
        <Header title="View Header/Footer" subtitle="View a Header/Footer" />
        ...
        <Box>
          <Button
            ...
            onClick={() => navigate("/dashboard/headerfooter")}
          >
...
export default ViewHeaderAndFooter;
