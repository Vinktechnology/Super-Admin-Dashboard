...
import { getAllProductsThunk, updateProductStatusThunk } from "../../store/slices/product/product.slice";
...
const Product = () => {
  const { products, totalCount } = useSelector(({ product }) => product?.productsdata);
