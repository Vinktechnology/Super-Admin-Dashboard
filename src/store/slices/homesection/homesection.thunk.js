...
export const getAllHomeSectionData = async (data, thunkApi) => {
  try { 
    thunkApi.dispatch(startDashboardLoader());
    const { user: userAxios } = thunkApi.extra.apiService;
    const response = await userAxios.get(`${getAllHomeSectionApi}?page=${data.page}&limit=${data.pageSize}`);
    const responseData = response?.data;
    return responseData;
...
export const addNewHomeSectionData = async (data, thunkApi) => {
  try {

    console.log("data home section", data)
    thunkApi.dispatch(startDashboardLoader());
    const { user: userAxios } = thunkApi.extra.apiService;
    const response = await userAxios.post(addNewHomeSectionApi,{...data});
...
export const getHomeSectionByIdData = async (data, thunkApi) => {
  try {
    thunkApi.dispatch(startDashboardLoader());
    const { user: userAxios } = thunkApi.extra.apiService;
    const response = await userAxios.get(`${getHomeSectionByIdApi}/${data}`);
    const responseData = response?.data?.homeSectionData;
    return responseData;
...
export const updateHomeSectionData = async (data, thunkApi) => {
  try {
    thunkApi.dispatch(startDashboardLoader());
    const { user: userAxios } = thunkApi.extra.apiService;
    
    const response = await userAxios.put(`${addNewHomeSectionApi}/${data.id}`,{...data});
    const responseData = response?.data;
...
export const updateHomeSectionStatusData = async (data, thunkApi) => {
  try {
    thunkApi.dispatch(startDashboardLoader());
    const { user: userAxios } = thunkApi.extra.apiService;
    const response = await userAxios.put(`${updateHomeSectionStatusApi}/${data.id}`,{...data});
    const responseData = response?.data;
