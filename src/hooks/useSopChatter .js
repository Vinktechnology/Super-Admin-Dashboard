...
function useSopChatter({ columnsIds, columns, sections: sectionsData, id }) {
  ...
  function updateRowData(sectionIdx, rowIdx, colIdx, value, type, resetRow) {
    ...
    const applyChanges = () => {
      ...
      var obj = {
        ...
        row_id: rowIdx,
        columns_data: newRowData,
      };
      dispatch(updateSopTableThunk(obj))
        .unwrap()
        .then(() => {
      ...
      // .then((data) => {
      // var obj = {
      //   sop_table_id: sectionIdx,
      //   row_id: rowIdx,
      //   columns_data: data.data.values,
      // };
      // dispatch(updateSopTableThunk(obj));
      // console.log(
      //   "sectionIdx   data.data.value--------------",
      //   data.data.values
      // );
      //  var obj ={
      // 	“sop_table_id”: sectionIdx,
      ...
      // 	“columns_data”: data.data.values
      // }
      // dispatch(fetchAggregateCommercialsByIdThunk(obj));
      // });
    };
